...
export const generateImage = async (req, res) => {
    try {
        ...
        // console.log("ClipDrop response headers:", response.headers);
        // console.log("ClipDrop response length:", response.data?.byteLength);

        // if (!response.data || !response.data.byteLength) {
        //   return res.json({ success: false, message: "ClipDrop did not return image data." });
        // }
...
export const resumeReview = async (req, res) => {
    try {
        ...
        its strength, weaknesses, and areas for improvement. Resume content:\n\n ${pdfData.text}`
