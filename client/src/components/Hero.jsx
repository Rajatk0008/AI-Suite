  ...
  return (
    ...
    justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
        <div className='text-center mb-6'>
            ...
            <p>Transform your content with our suite of premium AI tools and enhance your 
                work flow <br/> using article generation , image generation , and many more.</p>
        </div>
        <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
            <button onClick={() => navigate('/ai')} className='bg-primary text-white px-10 py-3 
            rounded-lg hover:scale-102 active:scale-95 transition'>Start creating now</button>
