...
const BlogTitles = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true)
      const prompt = `Generate some appealing blog-titles for the keyword ${input} in the category ${selectedCategory} , keep it under 150 words
      I dnt want the prompt and number of words to be displayed `
